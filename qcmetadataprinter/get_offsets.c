...
//    PRINT(CAM_INTF_META_LENS_FOCUS_STATE,       pMetadata); //NOTFOUND
    ...
    PRINT(MOTOROLA_RESERVED_PARAM_2,    pMetadata);
    PRINT(MOTOROLA_RESERVED_PARAM_1,    pMetadata);
    PRINT(MOTOROLA_RESERVED_PARAM_3,    pMetadata);
    PRINT(MOTOROLA_RESERVED_PARAM_4,    pMetadata);
